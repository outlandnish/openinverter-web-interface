        ...
        <nav class="sidebar-nav">
          ...
          <div class="sidebar-section">
            <div class="sidebar-section-header">
              <h3 class="sidebar-section-title">Devices</h3>
              {onQuickScan && (
                <button
                  class={`sidebar-scan-button ${scanning ? 'scanning' : ''}`}
                  onClick={onQuickScan}
                  title={scanDisabled ? "Cannot scan: ESP32 disconnected" : (scanning ? "Scanning..." : "Quick scan for devices")}
            ...
            {deviceEntries.length === 0 ? (
              <div class="sidebar-empty">
                ...
                <p class="hint">Scan for devices to get started</p>
              </div>
            ) : (
