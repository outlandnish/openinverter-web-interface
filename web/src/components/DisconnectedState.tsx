  ...
  return (
    <div class="disconnected-state-wrapper">
      <div class="disconnected-state-content">
        ...
        <p class="empty-state-text">ESP32 Disconnected</p>
        <p class="empty-state-hint">
          Unable to establish connection to the device. Please check that your ESP32 is powered on and connected to the network.
        </p>
