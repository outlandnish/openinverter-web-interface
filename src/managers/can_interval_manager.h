...
public:
  ...
  void startInterval(const char* intervalId, uint32_t canId, const uint8_t* data, uint8_t dataLength,
                     uint32_t intervalMs);
  ...
  void startCanIoInterval(uint32_t canId, uint16_t pot, uint16_t pot2, uint8_t canio, uint16_t cruisespeed,
                          uint8_t regenpreset, uint32_t intervalMs, bool useCrc);
  void stopCanIoInterval();
  void updateCanIoFlags(uint16_t pot, uint16_t pot2, uint8_t canio, uint16_t cruisespeed, uint8_t regenpreset);
